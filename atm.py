...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        tk.Frame.__init__(self, parent, bg='#9900cc')
        self.controller = controller

        self.controller.state('zoomed')

        label = tk.Label(self, text ="Welcome to ATM Simulation", font = LARGEFONT, fg='#ffffff', bg='#9900cc')
...
class Login(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.state('zoomed')
        label = tk.Label(self, text ="Login", font = LARGEFONT, fg='#ffffff', bg='#9900cc')
        label.grid(row = 0, column = 4, padx = 650, pady = 30)
  
        name_var = tk.StringVar()
        Login_label = tk.Label(self, text="Username", font = ('calibre',10, 'bold'), fg='#ffffff', bg='#9900cc')
        ...
        Password_label = tk.Label(self, text="Password", font=('calibre',10, 'bold'), fg='#ffffff', bg='#9900cc')
        ...
        incorrect = tk.Label(self, text='', font=('calibre', 16, 'bold'), fg='red', bg='#9900cc')
...
class Menu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.state('zoomed')
        label = tk.Label(self, text ="Menu", font = LARGEFONT, fg='#ffffff', bg='#9900cc')
        label.grid(row = 0, column = 4, padx = 650, pady = 30)
...
class Withdraw(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.controller.state('zoomed')
        label = tk.Label(self, text ="Withdraw", font = LARGEFONT, fg='#ffffff', bg='#9900cc')
        label.grid(row = 0, column = 4, padx = 650, pady = 30)

        withdraw_lable = tk.Label(self, text='Enter amount you want to Withdraw', font=('calibri', 20, 'bold'), fg='#ffffff', bg='#9900cc')
...
class Balance(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        bal_label = tk.Label(self, text='Your Current balance', font=('calibre', 20, 'bold'), fg='#ffffff', bg='#9900cc')
        bal_label.grid(row=3, column=4, padx=650, pady=10, ipadx=5, ipady=5)

        bal_msg = tk.Message(self, textvariable= controller.shared_data['Bal'],font=('calibre', 14, 'bold'), fg='#ffffff', bg='#9900cc')
...
class Deposit(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        deposit_label = tk.Label(self, text='Enter Amount to Deposit', font=('calibre',20,'bold'), fg='#ffffff', bg='#9900cc')
